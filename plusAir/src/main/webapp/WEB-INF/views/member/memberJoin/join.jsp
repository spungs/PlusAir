				...
				<div class="login">
					...
					<div class="container--default pc-30">
						<div class="icon-link">
							...
							<a href="javascript:;" class="icon-link__item"
							...
							</a> <a href="javascript:;" class="icon-link__item"
								data-action="goIDCheckIpin"> <img
								src="<c:url value="/resources/images/icon/icon-join-item-02.png" />"
								alt="" aria-hidden="true"> <span class="icon-link__text">아이핀
									인증<br>회원가입
							</span>
							</a> <a href="javascript:;" class="icon-link__item"
								data-action="goChildEmailWrite"> <img
								src="<c:url value="/resources/images/icon/icon-join-item-03.png" />"
								alt="" aria-hidden="true"> <span class="icon-link__text">만
									14세 미만<br>회원가입
							</span>
							</a>
						</div>
					...
					<div class="button-wrap button-wrap--login">
		              ...
		              <div class="link-wrap">
						...
						<div class="link-wrap">
							<button type="button" data-action="goRefCtfCheck"
								class="link-wrap__underline">
								<span>제휴카드 발급고객 회원가입</span>
							</button>
						</div>
					</div>
				</div>
