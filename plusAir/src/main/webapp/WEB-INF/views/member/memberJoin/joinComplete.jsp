...
추가정보는 나중에 [마이페이지]에서도 입력할 수 있습니다.</p>
          ...
          <div class="fixed-wrap section-wrap">
            <div class="button-wrap button-wrap--stick">
              <button type="button" data-action="nextBtn" class="button button--primary button--black"><span class="button__text">다음에 입력하기</span></button>
              <button type="button" data-action="writeBtn" class="button button--primary button--active"><span class="button__text">추가정보 입력하기</span></button>
            </div>
          </div>
          <!--//20210519 버튼영역 변경-->
