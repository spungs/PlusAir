		...
		<header class="header__inner mobile-only">
			...
			// 예매전 노출 -->
				...
				<button type="button" class="gnb__button">
					...
					<img
						src="<c:url value="/resources/img/icon-hamburger-header.png" />"
				...
				<div class="gnb-wrap">
					...
					<div class="gnb__footer">
						...
						<div class="sns-wrap">
							...
							</a> <a href="https://instagram.com/jejuair_official" target="_blank"
								class="sns-wrap__item"> <img loading="lazy"
				...
				<div class="header__box">
					...
					<h1 class="header__logo">
						...
						<a href="javascript:;" data-action="menu" data-menu-name="main">
							...
							<img
							src="<c:url value="/resources/images/banner_image/20211014191229348.png" />"
