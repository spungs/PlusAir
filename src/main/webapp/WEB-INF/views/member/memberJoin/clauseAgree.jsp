...
<div id="body">
	...
	<div class="content" id="content">
		<main id="main" class="main">
			...
			<button type="button" class="button button--primary button--active" id="nextBtn" data-action="nextBtn"><span class="button__text" onclick="nextBtn()">회원가입하기 </span></button>
			</div>
		</main>
	</div>
